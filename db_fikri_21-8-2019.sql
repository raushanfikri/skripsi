...
insert  into `buku_pkm`(`id`,`idpengabdian`,`nidn`,`judul`,`penerbit`,`isbn`,`halaman`,`file`,`keterangan`,`date`) values (2,1,'123','67','67','67','0','2016_Ankep_08_-_AHP.pdf','Disetujui',NULL),(3,NULL,'123','66','66','66','9','617-2163-1-PB1.pdf','Disetujui',NULL);
...
CREATE TABLE `detail_anggotapengabdian` (
  ...
  KEY `nidn` (`nidn`),
  CONSTRAINT `detail_anggotapengabdian_ibfk_1` FOREIGN KEY (`nidn`) REFERENCES `dosen` (`nidn`),
  CONSTRAINT `detail_anggotapengabdian_ibfk_2` FOREIGN KEY (`idpengabdian`) REFERENCES `pengabdiann` (`idpengabdian`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `detail_anggotapengabdian` */

insert  into `detail_anggotapengabdian`(`idpengabdian`,`nidn`,`ket`) values (1,'123','ketua');
...
CREATE TABLE `detail_luaran` (
  ...
  KEY `idluaran` (`idluaran`),
  CONSTRAINT `detail_luaran_ibfk_1` FOREIGN KEY (`idpenelitian`) REFERENCES `penelitian` (`idpenelitian`),
  CONSTRAINT `detail_luaran_ibfk_2` FOREIGN KEY (`idluaran`) REFERENCES `luaran` (`idluaran`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `detail_luaran` */

insert  into `detail_luaran`(`idpenelitian`,`idluaran`) values (2,1),(2,2),(2,3),(7,1),(4,2),(4,1);
...
CREATE TABLE `detail_luaranpengabdian` (
  ...
  KEY `idluaran` (`idluaran`),
  KEY `idpengabdian` (`idpengabdian`),
  CONSTRAINT `detail_luaranpengabdian_ibfk_1` FOREIGN KEY (`idluaran`) REFERENCES `luaran` (`idluaran`),
  CONSTRAINT `detail_luaranpengabdian_ibfk_2` FOREIGN KEY (`idpengabdian`) REFERENCES `pengabdiann` (`idpengabdian`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `detail_luaranpengabdian` */

insert  into `detail_luaranpengabdian`(`idpengabdian`,`idluaran`) values (1,3);
...
insert  into `hki`(`id`,`idpenelitian`,`nidn`,`judul`,`jenis`,`nomorpendaftaran`,`status`,`nohki`,`file`,`keterangan`,`date`) values (3,1,'123','fajskd','Paten','akjsdka','jadskdj','aksfjka','ijazah8.pdf','Menunggu Verifikasi','2019-08-20 06:27:02');
...
insert  into `hki_pkm`(`id`,`idpengabdian`,`nidn`,`judul`,`jenis`,`nomorpendaftaran`,`status`,`nohki`,`file`,`keterangan`,`date`) values (1,1,'123','gdfgfd','321','1212121','Disetujui','dsadsadsa','617-2163-1-PB1.pdf','Disetujui',NULL);
...
insert  into `jurnal_pkm`(`id`,`idpengabdian`,`nidn`,`judul`,`namajurnal`,`jenis`,`peranpenulis`,`tahun`,`volume`,`no`,`url`,`issn`,`file`,`keterangan`,`date`) values (1,1,'123','4','4','4','4','4','4','4','4','4','617-2163-1-PB.pdf','Disetujui',NULL);
...
insert  into `pengabdiann`(`idpengabdian`,`judulpenelitian`,`mitra`,`alamatmitra`,`kelompokmitra`,`jenis`,`bidang`,`tse`,`sumber`,`institusi`,`jumlah`,`file`,`keterangan`,`date`) values (1,'dkaskdl',NULL,NULL,NULL,'lakdlak','dlakldaks','alsfla','lakfla','uti','90','jpmanajemendd16143218.pdf','Menunggu Verifikasi','2019-08-19 11:24:30');
...
insert  into `seminar_pkm`(`id`,`idpengabdian`,`nidn`,`namaprosiding`,`tahunprosiding`,`peranpenulis`,`volume`,`no`,`isbn`,`url`,`jenisprosiding`,`file`,`keterangan`,`date`) values (2,NULL,'123','5','55','5','55','55k','5','5','5','617-2163-1-PB2.pdf','Disetujui',NULL);
