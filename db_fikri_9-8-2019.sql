...
insert  into `penelitian`(`id`,`nidn`,`judul`,`jenis`,`bidang`,`tse`,`sumber`,`institusi`,`jumlah`,`file`,`keterangan`,`date`) values (2,'123','qwer','wert1','LKDLSKA','LDKALSKD','DSKDLS','FLSFLSL','KFJKJS','938-953-3-PB.pdf','Disetujui',NULL);
...
insert  into `seminar`(`id`,`nidn`,`judul`,`jenis`,`jurnal`,`issn`,`volume`,`no`,`halaman`,`url`,`file`,`keterangan`,`date`) values (6,'123','2','266','2','2','2','2','44','2','617-2163-1-PB1.pdf','Disetujui',NULL),(7,'123','rttyui','lkaksdkasl1','SDKLSDKLAK','SLKDAL','sdsklkds','dakldkla','sdkalkd','sdkalskda','1193-1213-2-PB.pdf','Disetujui',NULL);
...
insert  into `seminar_pkm`(`id`,`nidn`,`judul`,`jenis`,`jurnal`,`issn`,`volume`,`no`,`halaman`,`url`,`file`,`keterangan`,`date`) values (2,'123','5','55','5','55','55k','5','5','5','617-2163-1-PB2.pdf','Disetujui',NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_penelitian` AS select `penelitian`.`nidn` AS `nidn`,`penelitian`.`id` AS `id`,`dosen`.`namadosen` AS `namadosen`,`penelitian`.`judul` AS `judul`,`penelitian`.`jenis` AS `jenis`,`penelitian`.`bidang` AS `bidang`,`penelitian`.`tse` AS `tse`,`penelitian`.`sumber` AS `sumber`,`penelitian`.`institusi` AS `institusi`,`penelitian`.`jumlah` AS `jumlah`,`penelitian`.`file` AS `file`,`penelitian`.`keterangan` AS `keterangan`,`penelitian`.`date` AS `date` from (`penelitian` join `dosen`) where (`penelitian`.`nidn` = `dosen`.`nidn`) */;
