...
insert  into `buku_pkm`(`id`,`idpengabdian`,`nidn`,`judul`,`penerbit`,`isbn`,`halaman`,`file`,`keterangan`,`date`) values (3,3,'123','66','66','66','9','617-2163-1-PB1.pdf','Disetujui','2019-07-01 22:30:16');
...
insert  into `detail_anggotapenelitian`(`idpenelitian`,`nidn`,`ket`) values (2,'123','ketua'),(3,'15311579','ketua'),(3,'123','anggota'),(4,'123','ketua'),(4,'15311579','anggota'),(5,'15311579','ketua'),(7,'123','ketua'),(7,'15311579','anggota');

/*Table structure for table `detail_anggotapengabdian` */

DROP TABLE IF EXISTS `detail_anggotapengabdian`;

CREATE TABLE `detail_anggotapengabdian` (
  `idpengabdian` int(11) NOT NULL AUTO_INCREMENT,
  `nidn` varchar(12) DEFAULT NULL,
  `ket` varchar(255) DEFAULT NULL,
  KEY `idpengabdian` (`idpengabdian`),
  KEY `detail_anggotapengabdian_ibfk_1` (`nidn`),
  CONSTRAINT `detail_anggotapengabdian_ibfk_1` FOREIGN KEY (`nidn`) REFERENCES `dosen` (`nidn`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `detail_anggotapengabdian_ibfk_2` FOREIGN KEY (`idpengabdian`) REFERENCES `pengabdiann` (`idpengabdian`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

/*Data for the table `detail_anggotapengabdian` */

insert  into `detail_anggotapengabdian`(`idpengabdian`,`nidn`,`ket`) values (1,'123','ketua'),(2,'123','ketua'),(3,'15311579','ketua'),(3,'123','anggota');

/*Table structure for table `detail_luaran` */

DROP TABLE IF EXISTS `detail_luaran`;

CREATE TABLE `detail_luaran` (
  `idpenelitian` int(11) DEFAULT NULL,
  `idluaran` int(11) DEFAULT NULL,
  KEY `detail_luaran_ibfk_1` (`idpenelitian`),
  KEY `detail_luaran_ibfk_2` (`idluaran`),
  CONSTRAINT `detail_luaran_ibfk_1` FOREIGN KEY (`idpenelitian`) REFERENCES `penelitian` (`idpenelitian`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `detail_luaran_ibfk_2` FOREIGN KEY (`idluaran`) REFERENCES `luaran` (`idluaran`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `detail_luaran` */

insert  into `detail_luaran`(`idpenelitian`,`idluaran`) values (2,1),(2,2),(2,3),(7,1),(7,2),(7,3),(7,4),(2,4),(5,1),(5,2),(5,3),(5,4),(5,5);

/*Table structure for table `detail_luaranpengabdian` */

DROP TABLE IF EXISTS `detail_luaranpengabdian`;

CREATE TABLE `detail_luaranpengabdian` (
  `idpengabdian` int(11) DEFAULT NULL,
  `idluaran` int(11) DEFAULT NULL,
  KEY `detail_luaranpengabdian_ibfk_1` (`idluaran`),
  KEY `detail_luaranpengabdian_ibfk_2` (`idpengabdian`),
  CONSTRAINT `detail_luaranpengabdian_ibfk_1` FOREIGN KEY (`idluaran`) REFERENCES `luaran` (`idluaran`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `detail_luaranpengabdian_ibfk_2` FOREIGN KEY (`idpengabdian`) REFERENCES `pengabdiann` (`idpengabdian`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `detail_luaranpengabdian` */

insert  into `detail_luaranpengabdian`(`idpengabdian`,`idluaran`) values (1,3),(2,2),(2,3),(2,1),(3,1),(2,4),(3,2),(3,3),(1,2),(1,4),(1,1),(3,4),(3,5);
...
insert  into `hki`(`id`,`idpenelitian`,`nidn`,`judul`,`jenis`,`nomorpendaftaran`,`status`,`nohki`,`file`,`keterangan`,`date`) values (3,2,'123','fajskd','Paten','akjsdka','jadskdj','aksfjka','ijazah8.pdf','Menunggu Verifikasi','2019-08-20 06:27:02');
...
insert  into `hki_pkm`(`id`,`idpengabdian`,`nidn`,`judul`,`jenis`,`nomorpendaftaran`,`status`,`nohki`,`file`,`keterangan`,`date`) values (2,3,'123','afasf','Hak Cipta','adasda','dadsadasdad','dada','ijazah10.pdf','Menunggu Verifikasi','2019-08-22 07:05:50');
...
insert  into `jurnal_pkm`(`id`,`idpengabdian`,`nidn`,`judul`,`namajurnal`,`jenis`,`peranpenulis`,`tahun`,`volume`,`no`,`url`,`issn`,`file`,`keterangan`,`date`) values (1,1,'123','raushan','firla','internasional','joki','201','4','fikri','5','5','617-2163-1-PB.pdf','Disetujui',NULL);
...
CREATE TABLE `luaran` (
  `idluaran` int(11) NOT NULL AUTO_INCREMENT,
  `namaluaran` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`idluaran`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

/*Data for the table `luaran` */

insert  into `luaran`(`idluaran`,`namaluaran`) values (1,'Publikasi'),(2,'HKI'),(3,'Buku Ajar'),(4,'Artikel Jurnal'),(5,'Artikel Prosiding');
...
insert  into `penelitian`(`idpenelitian`,`judulpenelitian`,`jenis`,`bidang`,`tse`,`sumber`,`institusi`,`jumlah`,`file`,`keterangan`,`date`) values (2,'qwerty','wert1','LKDLSKA','LDKALSKD','DSKDLS','FLSFLSL','KFJKJS','938-953-3-PB.pdf','Menunggu Verifikasi',NULL),(3,'909','90','90','990','90','9090','0','jpmanajemendd16143211.pdf','Disetujui','2019-08-13 07:09:40'),(4,'pppp','190','ppp','pp','p','pp','990','jpmanajemendd16143212.pdf','Disetujui','2019-08-13 12:37:20'),(5,'opopo','oop','ooo','ppp','pp','pp','90','jpmanajemendd16143213.pdf','Disetujui','2019-08-13 15:18:27'),(7,'contoh aja','internal','teknologi','uji coba','internal','uti','90000000','jpmanajemendd16143216.pdf','Disetujui','2019-08-16 12:45:02');
...
/*Table structure for table `pengabdiann` */

DROP TABLE IF EXISTS `pengabdiann`;

CREATE TABLE `pengabdiann` (
  `idpengabdian` int(11) NOT NULL AUTO_INCREMENT,
  `judulpenelitian` text,
  `mitra` text,
  `alamatmitra` text,
...
/*Data for the table `pengabdiann` */

insert  into `pengabdiann`(`idpengabdian`,`judulpenelitian`,`mitra`,`alamatmitra`,`kelompokmitra`,`jenis`,`bidang`,`tse`,`sumber`,`institusi`,`jumlah`,`file`,`keterangan`,`date`) values (1,'dkaskdl',NULL,NULL,NULL,'lakdlak','dlakldaks','alsfla','lakfla','uti','90','jpmanajemendd16143218.pdf','Menunggu Verifikasi','2019-08-19 11:24:30'),(2,'riririr','d','ajo','ca','oopo','p','opo','op','op','9000','ijazah.pdf','Disetujui','2019-08-22 11:11:23'),(3,'anak bawang','aska jaya','kedaton','umkm','terapam','itu','secondary','uti','uti','9000','jpmanajemendd16143220.pdf','Disetujui','2019-08-23 05:59:53');
...
insert  into `publikasiilmiah`(`id`,`idpenelitian`,`nidn`,`judul`,`institusi`,`tanggal`,`tempat`,`file`,`status`,`date`) values (5,2,'123','Oren','UTI','2019-07-20','kklklklkl1','617-2163-1-PB3.pdf','Disetujui',NULL),(7,3,'123','lkdlksdlk','ielele','2019-07-24','lslsks','2238-4532-1-PB1.pdf','Menunggu Verifikasi','2019-07-20 03:19:22'),(8,2,'123','hihi','iiii','2019-08-05','ii','jpmanajemendd16143218.pdf','Disetujui','2019-08-16 04:08:15');
...
insert  into `publikasiilmiah_pkm`(`id`,`idpengabdian`,`nidn`,`judul`,`institusi`,`tanggal`,`tempat`,`file`,`status`,`date`) values (1,2,'123','dajsdkj','kksdfjs','2019-08-01','fjksdj','','Menunggu Verifikasi','2019-08-22 09:19:57'),(2,3,'15311579','daskdjk','jkdsjk','2019-08-27','dksjkj','cv_kgs.pdf','Disetujui','2019-08-23 08:47:31');
...
insert  into `seminar`(`id`,`idpenelitian`,`nidn`,`namaprosiding`,`tahunprosiding`,`peranpenulis`,`volume`,`no`,`isbn`,`url`,`jenisprosiding`,`file`,`keterangan`,`date`) values (6,2,'123','2','266','2','2','2','44','2',NULL,'617-2163-1-PB1.pdf','Disetujui','2019-08-15 00:18:13'),(7,2,'123','rttyui','2012','SDKLSDKLAK','sdsklkds','12','sdkalkd','sdkalskda','41','1193-1213-2-PB.pdf','Menunggu Verifikasi','2019-08-24 00:18:06'),(8,3,'15311579','oo','2018','CO Author','90','90','90','ww','Terindeks','jpmanajemendd1614325.pdf','Belum Disetujui','2019-08-09 00:18:19'),(9,4,'123','kito','2019','First Author','hihihi','hihih','ihihi','hihi','Tidak Diketahui','jpmanajemendd1614326.pdf','Menunggu Verifikasi','2019-08-15 03:12:49'),(11,2,'123','dajkdjak','askdka','First Author','dasdadasdada','dasd','dasda','dads','Tidak Diketahui','jpmanajemendd1614328.pdf','Menunggu Verifikasi','2019-08-15 03:20:02');
...
insert  into `seminar_pkm`(`id`,`idpengabdian`,`nidn`,`namaprosiding`,`tahunprosiding`,`peranpenulis`,`volume`,`no`,`isbn`,`url`,`jenisprosiding`,`file`,`keterangan`,`date`) values (2,3,'123','5','55','5','55','55k','5','5','5','617-2163-1-PB2.pdf','Disetujui','2019-08-23 23:02:29');
...
/*Table structure for table `v_pengabdian` */

DROP TABLE IF EXISTS `v_pengabdian`;

/*!50001 DROP VIEW IF EXISTS `v_pengabdian` */;
/*!50001 DROP TABLE IF EXISTS `v_pengabdian` */;

/*!50001 CREATE TABLE  `v_pengabdian`(
 `idpengabdian` int(11) ,
 `nidn` varchar(12) ,
 `namadosen` varchar(255) ,
 `ket` varchar(255) ,
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_bukupkm` AS select `buku_pkm`.`id` AS `id`,`buku_pkm`.`nidn` AS `nidn`,`pengabdiann`.`idpengabdian` AS `idpengabdian`,`dosen`.`namadosen` AS `namadosen`,`buku_pkm`.`judul` AS `judul`,`buku_pkm`.`penerbit` AS `penerbit`,`buku_pkm`.`isbn` AS `isbn`,`buku_pkm`.`halaman` AS `halaman`,`buku_pkm`.`file` AS `file`,`buku_pkm`.`keterangan` AS `keterangan`,`buku_pkm`.`date` AS `date` from ((`dosen` join `pengabdiann`) join `buku_pkm`) where ((`buku_pkm`.`nidn` = `dosen`.`nidn`) and (`buku_pkm`.`idpengabdian` = `pengabdiann`.`idpengabdian`)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_hkipkm` AS select `hki_pkm`.`nidn` AS `nidn`,`hki_pkm`.`id` AS `id`,`pengabdiann`.`idpengabdian` AS `idpengabdian`,`dosen`.`namadosen` AS `namadosen`,`hki_pkm`.`judul` AS `judul`,`hki_pkm`.`jenis` AS `jenis`,`hki_pkm`.`nomorpendaftaran` AS `nomorpendaftaran`,`hki_pkm`.`status` AS `status`,`hki_pkm`.`nohki` AS `nohki`,`hki_pkm`.`file` AS `file`,`hki_pkm`.`keterangan` AS `keterangan`,`hki_pkm`.`date` AS `date` from ((`dosen` join `pengabdiann`) join `hki_pkm`) where ((`hki_pkm`.`nidn` = `dosen`.`nidn`) and (`hki_pkm`.`idpengabdian` = `pengabdiann`.`idpengabdian`)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_jurnalpkm` AS select `jurnal_pkm`.`id` AS `id`,`pengabdiann`.`idpengabdian` AS `idpengabdian`,`jurnal_pkm`.`nidn` AS `nidn`,`dosen`.`namadosen` AS `namadosen`,`jurnal_pkm`.`judul` AS `judul`,`jurnal_pkm`.`namajurnal` AS `namajurnal`,`jurnal_pkm`.`jenis` AS `jenis`,`jurnal_pkm`.`peranpenulis` AS `peranpenulis`,`jurnal_pkm`.`tahun` AS `tahun`,`jurnal_pkm`.`volume` AS `volume`,`jurnal_pkm`.`no` AS `no`,`jurnal_pkm`.`url` AS `url`,`jurnal_pkm`.`issn` AS `issn`,`jurnal_pkm`.`file` AS `file`,`jurnal_pkm`.`keterangan` AS `keterangan`,`jurnal_pkm`.`date` AS `date` from ((`dosen` join `pengabdiann`) join `jurnal_pkm`) where ((`jurnal_pkm`.`nidn` = `dosen`.`nidn`) and (`jurnal_pkm`.`idpengabdian` = `pengabdiann`.`idpengabdian`)) */;
...
/*View structure for view v_pengabdian */

/*!50001 DROP TABLE IF EXISTS `v_pengabdian` */;
/*!50001 DROP VIEW IF EXISTS `v_pengabdian` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_pengabdian` AS select `pengabdiann`.`idpengabdian` AS `idpengabdian`,`detail_anggotapengabdian`.`nidn` AS `nidn`,`dosen`.`namadosen` AS `namadosen`,`detail_anggotapengabdian`.`ket` AS `ket`,`pengabdiann`.`judulpenelitian` AS `judulpenelitian`,`pengabdiann`.`mitra` AS `mitra`,`pengabdiann`.`alamatmitra` AS `alamatmitra`,`pengabdiann`.`kelompokmitra` AS `kelompokmitra`,`pengabdiann`.`jenis` AS `jenis`,`pengabdiann`.`bidang` AS `bidang`,`pengabdiann`.`tse` AS `tse`,`pengabdiann`.`sumber` AS `sumber`,`pengabdiann`.`institusi` AS `institusi`,`pengabdiann`.`jumlah` AS `jumlah`,`pengabdiann`.`file` AS `file`,`pengabdiann`.`keterangan` AS `keterangan`,`pengabdiann`.`date` AS `date` from ((`pengabdiann` join `dosen`) join `detail_anggotapengabdian`) where ((`detail_anggotapengabdian`.`idpengabdian` = `pengabdiann`.`idpengabdian`) and (`detail_anggotapengabdian`.`nidn` = `dosen`.`nidn`)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_publikasipkm` AS select `publikasiilmiah_pkm`.`id` AS `id`,`pengabdiann`.`idpengabdian` AS `idpengabdian`,`publikasiilmiah_pkm`.`nidn` AS `nidn`,`dosen`.`namadosen` AS `namadosen`,`publikasiilmiah_pkm`.`judul` AS `judul`,`publikasiilmiah_pkm`.`institusi` AS `institusi`,`publikasiilmiah_pkm`.`tanggal` AS `tanggal`,`publikasiilmiah_pkm`.`tempat` AS `tempat`,`publikasiilmiah_pkm`.`file` AS `file`,`publikasiilmiah_pkm`.`status` AS `status`,`publikasiilmiah_pkm`.`date` AS `date` from ((`dosen` join `pengabdiann`) join `publikasiilmiah_pkm`) where ((`publikasiilmiah_pkm`.`nidn` = `dosen`.`nidn`) and (`publikasiilmiah_pkm`.`idpengabdian` = `pengabdiann`.`idpengabdian`)) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_seminarpkm` AS select `seminar_pkm`.`id` AS `id`,`pengabdiann`.`idpengabdian` AS `idpengabdian`,`seminar_pkm`.`nidn` AS `nidn`,`dosen`.`namadosen` AS `namadosen`,`seminar_pkm`.`namaprosiding` AS `namaprosiding`,`seminar_pkm`.`peranpenulis` AS `peranpenulis`,`seminar_pkm`.`tahunprosiding` AS `tahunprosiding`,`seminar_pkm`.`volume` AS `volume`,`seminar_pkm`.`no` AS `no`,`seminar_pkm`.`isbn` AS `isbn`,`seminar_pkm`.`url` AS `url`,`seminar_pkm`.`jenisprosiding` AS `jenisprosiding`,`seminar_pkm`.`file` AS `file`,`seminar_pkm`.`keterangan` AS `keterangan`,`seminar_pkm`.`date` AS `date` from ((`dosen` join `pengabdiann`) join `seminar_pkm`) where ((`seminar_pkm`.`nidn` = `dosen`.`nidn`) and (`seminar_pkm`.`idpengabdian` = `pengabdiann`.`idpengabdian`)) */;
