      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">	
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/admin/dosenpublikasipkm"> Publikasi Forum Ilmiah</a></li>
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/admin/publikasi"> Publikasi Forum Ilmiah</a></li>
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/admin/publikasipkm"> PKM - Publikasi Forum Ilmiah</a></li>
		...
		<li class="dropdown">
          ...
          <ul class="nav navbar-nav navbar-right">
			<li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="icon-user icon-white"></i> <?= $nama ?> <span class="caret"></span></a>
              <ul class="dropdown-menu" aria-labelledby="themes">
