...
<form action="<?php echo base_URL(); ?>index.php/admin/dosenseminar_pkm/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<a href="<?php echo base_URL(); ?>index.php/admin/dosenseminar_pkm" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
	</td></tr>
	</table>
</form>
</div>
