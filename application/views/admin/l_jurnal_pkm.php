...
<div class="panel panel-info">
	...
	//	if ($this->session->userdata('admin_level') == "Super Admin") {
		...
		<div class="col-md-4">
			<form class="navbar-form navbar-left" method="post" action="<?php echo base_URL(); ?>index.php/admin/jurnal_pkm/cari" style="margin-top: 0px">
...
<div class="panel panel-info">
	<div class="panel-heading" style="overflow: auto">
		<div class="row" >
			<form class="form-inline" action="<?php echo base_URL(); ?>index.php/admin/exportPDF/v_jurnalpkm"
				method="POST">
			  	<div class="col-md-1">
