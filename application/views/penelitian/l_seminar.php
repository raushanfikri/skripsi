<div class="clearfix">
	...
	<div class="panel panel-info">
		<div class="panel-heading" style="overflow: auto">
			<div class="col-md-6">
				<h3 style="margin-top: 5px">Data Seminar</h3>
			</div>
			<?php 
	//	if ($this->session->userdata('admin_level') == "Super Admin") {
		?>
			<div class="col-md-2">
				<a href="<?php echo base_URL(); ?>index.php/penelitian/seminar/add" class="btn btn-info"><i
	...
	<table class="table table-bordered table-hover" id="table">
		...
		?>
			<tr>
				...
				<td style="font-size: 11px">Tahun : <?php echo $b->tahunprosiding; ?><br>
				...
				<td style="font-size: 11px" class="ctr"><a href="<?= base_url('upload/seminar\/') . $b->file; ?>">
...
<?php
				...
				?>
<td class="ctr">
	<a href="<?= base_url('index.php/penelitian/seminar/edt/') . '/' . $b->id;?>" class="btn btn-success btn-sm"
		role="button" title="Ubah"><i class="icon-edit icon-white"> </i></a>
	<a href="<?= base_url('index.php/penelitian/seminar/del/') . '/' . $b->id;?>" class="btn btn-danger btn-sm"
