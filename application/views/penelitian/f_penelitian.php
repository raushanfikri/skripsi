...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 style="margin-top: 5px"> Tambah Data Penelitian</h3>
	</div>
</div>
<?php
} 
...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 style="margin-top: 5px"> Ubah Data Penelitian</h3>
	</div>
</div>
<?php
}
...
<div class="well">
	...
	<form action="<?php echo base_URL(); ?>index.php/penelitian/penelitiann/<?php echo $act; ?>" method="post"
	...
	?>
			<tr>
				...
				<td><b><input type="text" name="judulpenelitian" required value="<?php echo $judul; ?>"
							style="width: 700px" class="form-control" autofocus></b></td>
			</tr>
			<tr>
	...
	<tr><td width="20%">Anggota 2</td><td><b><input type="text" name="anggota_2" required value="<?php echo $anggota_2; ?>" style="width: 700px" class="form-control"></b></td></tr> -->
			...
			<tr>
				<td width="20%">TM</td>
				<td><b><input type="text" name="tse" required value="<?php echo $tm; ?>" style="width: 700px"
							class="form-control"></b></td>
			</tr>
			<tr>
			...
			<tr>
				<td width="20%">
					<br><button type="submit" class="btn btn-primary"><i class="icon icon-ok icon-white"></i>
						Simpan</button>
					<a href="<?php echo base_URL(); ?>index.php/penelitian/penelitiann" class="btn btn-success"><i
