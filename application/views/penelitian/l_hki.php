<div class="clearfix">
	...
	//	if ($this->session->userdata('admin_level') == "Super Admin") {
		?>
			<div class="col-md-2">
				<a href="<?php echo base_URL(); ?>index.php/penelitian/hki/add" class="btn btn-info"><i
	...
	<table class="table table-bordered table-hover" id="table">
		...
		?>
			<tr>
				...
				<td style="font-size: 11px" class="ctr"><a href="<?= base_url('upload/hki\/') . $b->file; ?>">
		...
		//	}
			?>
				<td class="ctr">
					<a href="<?= base_url('index.php/penelitian/hki/edt/') . '/' . $b->id;?>"
						class="btn btn-success btn-sm" role="button" title="Ubah"><i class="icon-edit icon-white"> </i></a>
					<a href="<?= base_url('index.php/penelitian/hki/del/') . '/' . $b->id;?>"
