...
<div class="well">
	...
	<form action="<?php echo base_URL(); ?>index.php/penelitian/buku/<?php echo $act; ?>" method="post"
	...
	?>
			...
			<tr>
				<td width="20%">NIDN</td>
				<td><b><input type="text" id="nidn" name="nidn" required value="<?php echo $nidn ?> "
			...
			<tr>
				<td width="20%">
					...
					<br><button type="submit" class="btn btn-primary"><i class="icon icon-ok icon-white"></i>
						Simpan</button>
					<a href="<?php echo base_URL(); ?>index.php/penelitian/detail_buku/<?php echo $this->session->userdata('idpenelitian'); ?>"
