...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	$(document).ready(function () {
		$(function () {
			$( "#kode_surat" ).autocomplete({
				source: function(request, response) {
					$.ajax({ 
						url: "<?php echo site_url('index.php/penelitian/get_klasifikasi'); ?>",
		...
		$(function () {
			$( "#dari" ).autocomplete({
				source: function(request, response) {
					$.ajax({ 
						url: "<?php echo site_url('index.php/penelitian/get_instansi_lain'); ?>",
						data: { kode: $("#dari").val()},
						dataType: "json",
						type: "POST",
						success: function(data){
  ...
  <body style="">
    <div class="navbar navbar-inverse navbar-fixed-top" style="background-color: #c80505;z-index: 5;" style="margin-top: 0;">
      <div class="container">
       
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav" >	
			<li><a href="<?php echo base_url(); ?>index.php/penelitian"><i class="icon-home icon-white"> </i> Beranda</a></li>
            
			<!-- <?php
			print_r($this->session->userdata('admin_level'));
    ...
    <div class="container">
      ...
      <div class="page-header" id="banner">
		...
		<?php $this->load->view('penelitian/'.$page); ?>
