		...
		?>
			<tr>
				...
				<td class="ctr">
					...
					<a href="<?= base_url('index.php/penelitian/detail_publikasi/') . '/' . $b->idpenelitian;?>"
						class="btn btn-warning btn-sm" title="Tambah Data Publikasi"><i class="icon-file icon-white">
						</i></a>
