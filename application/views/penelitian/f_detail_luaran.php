...
<div class="well">
  ...
  <!-- /.box-header -->
  <!-- form start -->
  <form method="post" action="<?=base_url()?>index.php/penelitian/simpan_luaran">
    <div class="box-body">
    ...
    <div class="box-footer">
      ...
      <a href="<?php echo base_URL(); ?>index.php/penelitian/penelitiann" class="btn btn-success">
...
<table class="table table-bordered table-hover" id="anggota">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?=$r->namaluaran?></td>
      <td class="ctr">
        <a href="<?=base_url()?>index.php/penelitian/hapus_luaran/<?=$r->idpenelitian?>/<?=$r->idluaran?>" class="btn btn-danger btn-xs" >Hapus</a>
