<div class="clearfix">
	...
	//	if ($this->session->userdata('admin_level') == "Super Admin") {
		?>
			<div class="col-md-2">
				<a href="<?php echo base_URL(); ?>index.php/pkm/jurnal/add" class="btn btn-info"><i
		...
		?>
			...
			<!-- <div class="col-md-4">
				<form class="navbar-form navbar-left" method="post"
					action="<?php echo base_URL(); ?>index.php/pkm/jurnal/cari" style="margin-top: 0px">
...
<?php
				...
				?>
					<td class="ctr">
						<a href="<?= base_url('index.php/pkm/jurnal/edt/') . '/' . $b->id;?>" class="btn btn-success btn-sm"
							role="button" title="Ubah"><i class="icon-edit icon-white"> </i></a>
						<a href="<?= base_url('index.php/pkm/jurnal/del/') . '/' . $b->id;?>" class="btn btn-danger btn-sm"
