...
<form action="<?php echo base_URL(); ?>index.php/pkm/jurusan/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<a href="<?php echo base_URL(); ?>index.php/pkm/jurusan" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
	</td></tr>
...
$(document).ready(function () {
  $(function () {
    $("#namafakultas").autocomplete({    //id kode sebagai key autocomplete yang akan dibawa ke source url
        minLength:1,
        delay:0,
        source:'<?php echo site_url('index.php/pkm/get_datafakultas'); ?>',   //nama source kita ambil langsung memangil fungsi get_allkota
