...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 style="margin-top: 5px"> Tambah Data Pemakalah Forum Ilmiah PKM</h3>
	</div>
</div>
<?php
} 
...
<div class="panel panel-info">
	<div class="panel-heading">
		<h4 style="margin-top: 5px"> Ubah Data Publikasi Forum Ilmiah PKM</h4>
	</div>
</div>
<?php
}
...
<form action="<?php echo base_URL(); ?>index.php/pkm/publikasipkm/<?php echo $act; ?>" method="post"
	...
	?>
			...
			<tr>
				...
				<td><b><input type="text" name="tanggal" tabindex="7" required value="<?php echo $tanggal; ?>"
							id="tgl_surat" style="width: 300px" class="form-control"></b></td>
			</tr>
			<tr>
				<td width="20%">Tempat</td>
				<td><b><input type="text" name="tempat" required value="<?php echo $tempat; ?>" style="width: 700px"
			...
			<tr>
				<td width="20%">
					<br><button type="submit" class="btn btn-primary"><i class="icon icon-ok icon-white"></i>
						Simpan</button>
					<a href="<?php echo base_URL(); ?>index.php/pkm/detail_publikasipkm/<?php echo $this->session->userdata('idpengabdian'); ?>"
