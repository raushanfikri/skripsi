...
<div class="well">
  ...
  <!-- /.box-header -->
  <!-- form start -->
  <form method="post" action="<?=base_url()?>index.php/pkm/simpan_anggotapengabdian">
    <div class="box-body">
    ...
    <div class="box-footer">
      ...
      <a href="<?php echo base_URL(); ?>index.php/pkm/pengabdian" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
    </div>
  </form>
</div>
<!-- /.box -->
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="<?=base_url()?>index.php/pkm/hapus_anggotapengabdian/<?=$r->idpengabdian?>/<?=$r->nidn?>" class="btn btn-danger btn-xs">Hapus</a>
        <?php }else{ ?>
