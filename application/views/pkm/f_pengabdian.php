...
<div class="well">
	...
	<form action="<?php echo base_URL(); ?>index.php/pkm/pengabdian/<?php echo $act; ?>" method="post"
	...
	?>
			<tr>
				<td width="20%">NIDN</td>
				<td><b><input type="text" name="nidn" required value="<?php echo $nidn; ?>" style="width: 150px"
							class="form-control" readonly></b></td>
			</tr>
			...
			<tr>
				<td width="20%">
					<br><button type="submit" class="btn btn-primary"><i class="icon icon-ok icon-white"></i>
						Simpan</button>
					<a href="<?php echo base_URL(); ?>index.php/pkm/pengabdian" class="btn btn-success"><i
