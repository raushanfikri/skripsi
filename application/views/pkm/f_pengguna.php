<div class="panel panel-info">
	...
	<form action="<?php echo base_URL(); ?>index.php/pkm/pengguna/act_edt" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="col-lg-6">
		...
		<a href="<?php echo base_URL(); ?>index.php/pkm" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
		</td></tr>
		</table>
	</div>
	...
	<div class="col-lg-6">	
		<table width="100%" class="table-form">
			...
			<tr><td width="20%">NIP Pimpinan</td><td><b><input type="text" name="nrp_pimpinan" required value="<?php echo $data->nrp_pimpinan; ?>" style="width: 300px" class="form-control"></b></td></tr>
