<div class="clearfix">
	...
	//	if ($this->session->userdata('admin_level') == "Super Admin") {
		?>
            <div class="col-md-12">
                <!-- <a href="<?php echo base_URL(); ?>index.php/pkm/pengabdian/add" class="btn btn-info"><i
    ...
    <table class="table table-bordered table-hover" id="table">
		...
		?>
            ...
            <td style="font-size: 11px"><?php echo $no; ?></td>
                ...
                <td class="ctr">
                <a href="<?= base_url('index.php/pkm/detail_seminarpkm/') . '/' . $b->idpengabdian;?>"
                        class="btn btn-info btn-sm" title="Tambah Data Publikasi"><i class="icon-file icon-white">
                        </i></a>
                ...
                <td class="ctr">
                    <a href="<?= base_url('index.php/pkm/detail_jurnalpkm/') . '/' . $b->idpengabdian;?>"
                        class="btn btn-info btn-sm" title="Tambah Data publikasi"><i class="icon-file icon-white">
                        </i></a>
                    <a href="<?= base_url('index.php/pkm/pengabdian/edt/') . '/' . $b->idpengabdian;?>"
                        class="btn btn-success btn-sm" title="Ubah"><i class="icon-edit icon-white"> </i></a>
                    <a href="<?= base_url('index.php/pkm/pengabdian/del/') . '/' . $b->idpengabdian;?>"
