<div class="clearfix">
	...
	//	if ($this->session->userdata('admin_level') == "Super Admin") {
		?>
			<div class="col-md-2">
				<a href="<?php echo base_URL(); ?>index.php/pkm/dosen/add" class="btn btn-info"><i
	...
	<table class="table table-bordered table-hover" id="table">
		...
		//	if ($this->session->userdata('admin_level') == "Super Admin") {
			?>
				<td class="ctr">
					<div class="btn-group">
						<a href="<?php echo base_URL(); ?>index.php/pkm/dosen/edt/<?php echo $b->nidn; ?>"
							class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Edit</a>
						<a href="<?php echo base_URL()?>index.php/pkm/dosen/del/<?php echo $b->nidn?>"
