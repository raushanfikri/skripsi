		...
		<tr>
			...
			<td class="ctr">
				...
				<div class="btn-group">
 				...
 				<td class="ctr">
 						<a href="<?= base_url('index.php/dosen/detail_publikasi/') . '/' . $b->idpenelitian;?>" class="btn btn-primary btn-sm" title="Tambah Data Publikasi"><i class="icon-list icon-white"> </i></a>
