...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 style="margin-top: 5px"> Ubah Data Hak Kekayaan Intelektual (HKI)</h3>
	</div>
</div>
<?php
}
...
<div class="well">
	...
	<form action="<?php echo base_URL(); ?>index.php/dosen/dosenhki_pkm/<?php echo $act; ?>" method="post"
			...
			<tr>
				<td width="20%">
					<br><button type="submit" class="btn btn-primary"><i class="icon icon-ok icon-white"></i>
						Simpan</button>
					<a href="<?php echo base_URL(); ?>index.php/dosen/detail_hkipkm/<?php echo $this->session->userdata('idpengabdian'); ?>"
