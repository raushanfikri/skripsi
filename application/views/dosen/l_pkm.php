      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">	
			<li><a href="<?php echo base_url(); ?>index.php/pkm"><i class="icon-home icon-white"> </i> Beranda</a></li>
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/dosenpublikasipkm"> Pemakalah Forum Ilmiah</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/dosenhki_pkm"> Hak Kekayaan Intelektual (HKI)</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/dosenbuku_pkm"> Buku Ajar / Teks</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/dosenjurnal_pkm"> Jurnal</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/dosenseminar_pkm"> Seminar</a></li>
                <!-- <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/dosenpenelitian_pkm"> Penelitian</a></li> -->
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="themes">
				<li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/dosen">Data Dosen</a></li>
			...
			<!-- <li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/publikasi"> Pemakalah Forum Ilmiah</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/hki"> Hak Kekayaan Intelektual (HKI)</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/buku"> Buku Ajar / Teks</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/jurnal"> Jurnal</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/seminar"> Seminar</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/penelitian"> Penelitian</a></li>
              </ul>
            </li> -->
			<li class="dropdown">
		...
		<li class="dropdown">
          ...
          <ul class="nav navbar-nav navbar-right">
			<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/pkm/passwod">Ubah Password</a></li>
