...
<div class="panel panel-info">
	<div class="panel-heading"><h3 style="margin-top: 5px"> Tambah Data Penelitian PKM</h3></div>
</div>
<?php
} 
else
...
<form action="<?php echo base_URL(); ?>index.php/admin/dosenpenelitian_pkm/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<tr><td width="20%">Anggota 1</td><td><b><input type="text" name="penulis_2" required value="<?php echo $anggota_1; ?>" style="width: 700px" class="form-control"></b></td></tr>		
	<tr><td width="20%">Anggota 2</td><td><b><input type="text" name="penulis_3" required value="<?php echo $anggota_2; ?>" style="width: 700px" class="form-control"></b></td></tr>		
	...
	<a href="<?php echo base_URL(); ?>index.php/admin/dosenpenelitian_pkm" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
	</td></tr>
	</table>
</form>
</div>
