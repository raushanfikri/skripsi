...
<table class="table table-bordered table-hover" id="table">
	...
	<tbody>
		...
		<tr>
			...
			<td class="ctr"><a href="<?= base_url('upload/penelitian\/') . $b->file; ?>" >
			...
			<td class="ctr">
				...
				<div class="btn-group">
 				...
 				<td class="ctr">
 						<a href="#" class="btn btn-primary btn-sm" role="button" disabled><i class="icon-list icon-white"> </i></a>
				...
				<td class="ctr">
						<a href="<?= base_url('index.php/dosen/detail_anggota/') . '/' . $b->idpenelitian;?>" class="btn btn-primary btn-sm" title="Tambah Data Anggota"><i class="icon-list icon-white"> </i></a>
						<a href="<?= base_url('index.php/dosen/dosenpenelitian/edt/') . '/' . $b->idpenelitian;?>" class="btn btn-success btn-sm" title="Ubah"><i class="icon-edit icon-white"> </i></a>
						<a href="<?= base_url('index.php/dosen/dosenpenelitian/del/') . '/' . $b->idpenelitian;?>" class="btn btn-danger btn-sm" title="Hapus"><i class="icon-remove icon-white"> </i></a>
