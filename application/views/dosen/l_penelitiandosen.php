<div class="clearfix">
	...
	//	if ($this->session->userdata('admin_level') == "Super Admin") {
		?>
			<div class="col-md-12">
				<a href="<?php echo base_URL(); ?>index.php/dosen/dosenpenelitian/add" class="btn btn-info"><i
	...
	<table class="table table-bordered table-hover" id="table">
		...
		?>
			<tr>
				...
				<td class="ctr">
					<a href="<?= base_url('index.php/dosen/detail_anggota/') . '/' . $b->idpenelitian;?>"
						class="btn btn-info btn-sm" title="Tambah Data Anggota"><i class="icon-list icon-white">
						</i></a>
					<a href="<?= base_url('index.php/dosen/detail_luaran/') . '/' . $b->idpenelitian;?>"
						class="btn btn-warning btn-sm" title="Tambah Data Anggota"><i class="icon-file icon-white">
						</i></a>
