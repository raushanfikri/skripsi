<div class="clearfix">
	...
	//	if ($this->session->userdata('admin_level') == "Super Admin") {
		?>
			<div class="col-md-2">
				<a href="<?php echo base_URL(); ?>index.php/dosen/dosenseminar/add" class="btn btn-info"><i
	...
	<table class="table table-bordered table-hover" id="table">
		...
		?>
			<tr>
				...
				<td class="ctr">
					<a href="<?= base_url('index.php/dosen/dosenseminar/del/') . '/' . $b->id;?>"
						class="btn btn-danger btn-sm"><i class="icon-remove icon-white" target="_blank" title="Hapus">
						</i></a>
					<a href="<?= base_url('index.php/dosen/dosenseminar/edt/') . '/' . $b->id;?>"
