      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">	
			<li><a href="<?php echo base_url(); ?>index.php/dosen"><i class="icon-home icon-white"> </i> Beranda</a></li>
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenpublikasi"> Pemakalah Forum Ilmiah</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenhki"> Hak Kekayaan Intelektual (HKI)</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenbuku"> Buku Ajar / Teks</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenjurnal"> Jurnal</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenseminar"> Seminar</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenpenelitian"> Penelitian</a></li>
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenpublikasipkm"> Pemakalah Forum Ilmiah</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenhki_pkm"> Hak Kekayaan Intelektual (HKI)</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenbuku_pkm"> Buku Ajar / Teks</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenjurnal_pkm"> Jurnal</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosenseminar_pkm"> Seminar</a></li>
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="themes">
				<li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/dosen">Data Dosen</a></li>
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/publikasi"> Pemakalah Forum Ilmiah</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/hki"> Hak Kekayaan Intelektual (HKI)</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/buku"> Buku Ajar / Teks</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/jurnal"> Jurnal</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/seminar"> Seminar</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/penelitian"> Penelitian</a></li>
              </ul>
            </li>
			<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/publikasipkm"> PKM - Pemakalah Forum Ilmiah</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/hki_pkm"> PKM - Hak Kekayaan Intelektual (HKI)</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/buku_pkm"> PKM - Buku Ajar / Teks</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/jurnal_pkm"> PKM - Jurnal</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/seminar_pkm"> PKM - Seminar</a></li>
		...
		<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/pengguna">Instansi Pengguna</a></li>
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/manage_admin">Manajemen User</a></li>
              </ul>
            </li>
			<?php 
			}
          ...
          <ul class="nav navbar-nav navbar-right">
			<li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a tabindex="-1" href="<?php echo base_url(); ?>index.php/dosen/passwod">Ubah Password</a></li>
