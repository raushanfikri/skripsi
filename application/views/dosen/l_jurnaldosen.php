...
<div class="panel panel-info">
	...
	//	if ($this->session->userdata('admin_level') == "Super Admin") {
		?>
		<div class="col-md-2">
			<a href="<?php echo base_URL(); ?>index.php/dosen/dosenjurnal/add" class="btn btn-info"><i class="icon-plus-sign icon-white"> </i> Tambah Data</a>
		</div>
		<?php 
		//}
		...
		<div class="col-md-4">
			<form class="navbar-form navbar-left" method="post" action="<?php echo base_URL(); ?>index.php/dosen/dosenjurnal/cari" style="margin-top: 0px">
	...
	<tbody>
		...
		<tr>
			...
			<td class="ctr">
				...
				<td class="ctr">
						<a href="<?= base_url('index.php/dosen/dosenjurnal/del/') . '/' . $b->id;?>" class="btn btn-danger btn-sm"><i class="icon-remove icon-white"> </i></a>
						<a href="<?= base_url('index.php/dosen/dosenjurnal/edt/') . '/' . $b->id;?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i></a>
					</td>
