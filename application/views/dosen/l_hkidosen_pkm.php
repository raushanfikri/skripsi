<div class="clearfix">
	...
	<div class="panel panel-info">
		<div class="panel-heading" style="overflow: auto">
			<div class="col-md-6">
				<h3 style="margin-top: 5px">Data Hak Kekayaan Intelektual (HKI) Pengabdian</h3>
			</div>
			<?php 
	//	if ($this->session->userdata('admin_level') == "Super Admin") { 
		?>
			<div class="col-md-2">
				<a href="<?php echo base_URL(); ?>index.php/dosen/dosenhki_pkm/add" class="btn btn-info"><i
	...
	<table class="table table-bordered table-hover" id="table">
		...
		?>
			<tr>
				...
				<td class="ctr">
					<a href="<?= base_url('index.php/dosen/dosenhki_pkm/del/') . '/' . $b->id;?>"
						class="btn btn-danger btn-sm"><i class="icon-remove icon-white" title="Hapus">
						</i></a>
					<a href="<?= base_url('index.php/dosen/dosenhki_pkm/edt/') . '/' . $b->id;?>"
