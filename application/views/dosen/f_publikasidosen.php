...
?>
	...
	<div class="well">
		...
		<form action="<?php echo base_URL(); ?>index.php/dosen/dosenpublikasi/<?php echo $act; ?>" method="post"
				...
				<tr>
					<td width="20%">
						<br><button type="submit" class="btn btn-primary"><i class="icon icon-ok icon-white"></i>
							Simpan</button>
						<a href="<?php echo base_URL(); ?>index.php/dosen/detail_publikasi/<?php echo $this->session->userdata('idpenelitian'); ?>"
