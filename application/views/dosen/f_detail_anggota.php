...
<div class="well">
  ...
  <!-- /.box-header -->
  <!-- form start -->
  <form method="post" action="<?=base_url()?>index.php/dosen/simpan_anggota">
    <div class="box-body">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="<?=base_url()?>index.php/dosen/hapus_anggota/<?=$r->idpenelitian?>/<?=$r->nidn?>" class="btn btn-danger btn-xs">Hapus</a>
        <?php }else{ ?>
