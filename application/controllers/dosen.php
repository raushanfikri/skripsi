...
class dosen extends CI_Controller {
	...
	public function manage_admin() {
		...
		if ($mau_ke == "del") {
			...
			redirect('index.php/dosen/manage_admin');
		} else if ($mau_ke == "cari") {
	...
	public function dosen() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/dosen/p");
		$a += array(
			'nama'=> $this->session->userdata('admin_nama'),
			'id'=> $this->session->userdata('admin_id'),
		);
		...
		if ($mau_ke == "cari") {
			...
			$this->session->set_flashdata("k", "<div class=\"alert alert-success\" id=\"alert\">Data has been updated</div>");			
			redirect('index.php/dosen/dosen');
		} else if ($mau_ke == "act_add") {
	...
	public function buku() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/buku/p");
		$a += array(
			'nama'=> $this->session->userdata('admin_nama'),
			'id'=> $this->session->userdata('admin_id'),
		);
	...
	public function jurnal() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/jurnal/p");
		$a += array(
			'nama'=> $this->session->userdata('admin_nama'),
			'id'=> $this->session->userdata('admin_id'),
		);
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/jurnal');
		}
	...
	public function jurnal_pkm() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/jurnal_pkm/p");
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/jurnal_pkm');
		}
	...
	public function penelitian() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/penelitian/p");
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/penelitian');
		}
	...
	public function penelitian_pkm() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/penelitian_pkm/p");
		...
		if ($mau_ke == "cari") {
			...
			$this->session->set_flashdata("k", "<div class=\"alert alert-success\" id=\"alert\">Data has been deleted</div>");			
			redirect('index.php/dosen/penelitian_pkm');
		}else if ($mau_ke == "edt") {
	...
	public function seminar() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/seminar/p");
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/seminar');
		}
	...
	public function seminar_pkm() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/seminar_pkm/p");
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/seminar_pkm');
		}
	...
	public function buku_pkm() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/buku_pkm/p");
		...
		if ($mau_ke == "cari") {
			...
			$this->session->set_flashdata("k", "<div class=\"alert alert-success\" id=\"alert\">Data Berhasil DiHapus</div>");			
			redirect('index.php/dosen/buku_pkm');
		}
	...
	public function publikasi() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/publikasi/p");
		$a += array(
			'nama'=> $this->session->userdata('admin_nama'),
			'id'=> $this->session->userdata('admin_id'),
		);
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/publikasi');
		}
		else if ($mau_ke == "del") {
	...
	public function hki() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/hki/p");
		$a += array(
			'nama'=> $this->session->userdata('admin_nama'),
			'id'=> $this->session->userdata('admin_id'),
		);
	...
	public function hki_pkm() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/hki_pkm/p");
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/hki_pkm');
		}
	...
	public function publikasipkm() {
		...
		$a['pagi']	= _page($total_row, $per_page, 4, base_url()."index.php/dosen/publikasipkm/p");
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/publikasipkm');
		} else if ($mau_ke == "del") {
	...
	public function dosenpublikasi() {
		...
		if ($mau_ke == "cari") {
			...
			if ($this->upload->do_upload('file_surat')) {
				...
				$this->db->query("INSERT INTO publikasiilmiah VALUES (NULL, '$nidn', '$judul', '$institusi', '$tanggal', '$tempat','".$up_data['file_name']."','$keterangan','$date')");
			} else {
			...
			redirect('index.php/dosen/dosenpublikasi');
		} else if ($mau_ke == "del") {
			$this->db->query("DELETE FROM publikasiilmiah WHERE id = '$idu'");
			$this->session->set_flashdata("k", "<div class=\"alert alert-success\" id=\"alert\">Data Berhasil DiHapus</div>");			
			redirect('index.php/dosen/dosenpublikasi');
	...
	public function dosenhki() {
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/dosenhki');
		} else if ($mau_ke == "del") {
			$this->db->query("DELETE FROM hki WHERE id = '$idu'");
			$this->session->set_flashdata("k", "<div class=\"alert alert-success\" id=\"alert\">Data Berhasil DiHapus </div>");			
			redirect('index.php/dosen/dosenhki');
	...
	public function dosenbuku() {
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/dosenbuku');
	...
	public function dosenjurnal() {
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/dosenjurnal');
		}
			...
			if ($this->upload->do_upload('file_surat')) {
				$up_data	 	= $this->upload->data();
				// die(print_r($up_data));
				$query = "UPDATE jurnal SET nidn='$nidn', judul='$judul', jenis='$jenis', penulis_2='$penulis_2', penulis_3='$penulis_3',jurnal='$jurnal',issn='$issn',volume='$volume',no='$nomor',halaman='$halaman',url='$url',file='$up_data[file_name]', keterangan='$keterangan' WHERE id = '$id'";
				$this->db->query($query);
				$this->session->set_flashdata("k", "<div class=\"alert alert-success\" id=\"alert\">Data Berhasil DiUbah</div>");
			}else{
				// die('blah');
	...
	public function dosenseminar() {
		...
		if ($mau_ke == "cari") {
			...
			redirect('index.php/dosen/dosenseminar');
		}
